...
export interface CharacterStage {
  ...
  bgTransformPC?: string;
  bgTransformMobile?: string;
}
...
export const CHARACTER_STAGES: CharacterStage[] = [
  ...
  { stage: 3, title: "Engineer",  minLevel: 25,  bgKey: "validatorTemple", glowColor: "#06b6d4", characterKey: "engineer", bgTransformMobile: "scale(1.35) translateY(-12%)" },
  { stage: 4, title: "Validator", minLevel: 50,  bgKey: "monadCity",       glowColor: "#6E54FF", characterKey: "validator", bgTransformPC: "scale(1.35) translateY(-12%)", bgTransformMobile: "scale(1.35) translateY(-12%)" },
