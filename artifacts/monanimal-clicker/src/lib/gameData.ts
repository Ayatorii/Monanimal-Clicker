...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "level_builder", name: "Builder", description: "Reach Builder rank (Level 15)", icon: "🏗️", check: (s) => s.characterLevel >= 15 },
  { id: "level_engineer", name: "Engineer", description: "Reach Engineer rank (Level 40)", icon: "🔧", check: (s) => s.characterLevel >= 40 },
  { id: "level_validator", name: "Validator", description: "Reach Validator rank (Level 60)", icon: "⚡", check: (s) => s.characterLevel >= 60 },
  { id: "level_explorer", name: "Explorer", description: "Reach Explorer rank (Level 100)", icon: "🗺️", check: (s) => s.characterLevel >= 100 },
  { id: "level_founder", name: "Founder", description: "Reach Founder rank (Level 250)", icon: "👑", check: (s) => s.characterLevel >= 250 },
