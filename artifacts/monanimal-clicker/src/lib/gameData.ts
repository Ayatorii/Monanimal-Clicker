...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "first_upgrade", name: "First Upgrade", description: "Buy first upgrade", icon: "⬆️", check: (s) => Object.values(s.upgrades).reduce((a: any, b: any) => a + b, 0) >= 1 },
  { id: "upgrade_addict", name: "Upgrade Addict", description: "Own 10 upgrades", icon: "🛒", check: (s) => Object.values(s.upgrades).reduce((a: any, b: any) => a + b, 0) >= 10 },
