  ...
  return (
    <div ref={containerRef} className="relative w-full h-full overflow-hidden select-none">
      ...
      {ownedItems.includes("ai_agent") && (
        ...
        >
          <img src={ITEMS.ai_agent} alt="AI Agent" className="w-[100px] h-[100px] object-contain" style={{ filter: `drop-shadow(0 0 8px ${stageData.glowColor})` }} />
        </motion.div>
      )}
      {ownedItems.includes("validator_node") && (
        ...
        >
          <img src={ITEMS.validator_node} alt="Validator Node" className="w-[100px] h-[100px] object-contain" style={{ filter: `drop-shadow(0 0 8px ${stageData.glowColor})` }} />
        </motion.div>
      )}
